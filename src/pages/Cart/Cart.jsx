...
function Cart() {
  ...
  const dispatch = useDispatch() // for delete function
...
// local storage se delete karna ka lia cart...
  useEffect(() => {
...
//     console.log(addressInfo)
    ...
    //Razorpay
    var options = {
      key: "rzp_test_su7j7Y5gwQj1Xf",
      key_secret: "64zuRGwpcVo4eqZ2kl7jXr5R",
...
try {
  ...
  return (
    <Layout >
      <div className="h-screen bg-gray-100 pt-5 mb-[40%] " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            return(
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <h2 className="text-sm  text-gray-900 mt-5" style={{ color: mode === 'dark' ? 'white' : '' }}>{description}</h2>
                  <p className="mt-5 text-xs font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>Rs:{price}</p>
                </div>
